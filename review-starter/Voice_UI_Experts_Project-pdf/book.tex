...
\def\starter@caption@needspace{4.8zh}
...
\usepackage[dvipdfmx,bookmarks=true,bookmarksnumbered=true,colorlinks=true,%
     pdftitle={Voiceflow \& VUI ～虎の巻～},%
     pdfauthor={Voice UI Experts}]{hyperref}
...
%%%
\title{Voiceflow \& VUI ～虎の巻～}
\makeatletter
\def\@subtitle{}
\def\@pubevent{技術書典8（2020年春）新刊}
\def\@latestpubhistory{2020年2月29日　ver 1.0}
\makeatother
\author{Voice UI Experts　著}
\date{2020{-}02{-}29 版\hspace{2zw} 発行}
%%%
\begin{titlepage}
...
\begin{center}%
  \mbox{} \vskip5zw
   \reviewtitlefont%
    {\HUGE\bfseries Voiceflow \& VUI ～虎の巻～ \par}%
    \vskip 1em%
    ...
    {\LARGE
      ...
      \end{tabular}\par}%
    \vfill
    {\large 2020{-}02{-}29 版\hspace{2zw} 発行\par}%
\vskip4zw\mbox{}
  \end{center}%
  \fi                    %%%%%%%%%%
\end{titlepage}
...
\mainmatter
\input{chapxx-aiminakajima.tex}
\input{chapxx-fukumura-kaigo.tex}
\input{chapxx-gaomar.tex}
\input{chapxx-kun432.tex}
\input{chapxx-magistralla.tex}
\input{chapxx-mr-mo.tex}
\input{chapxx-sitopp.tex}
\input{chapxx-vui-rie.tex}
...
\ifdefined\mycolophon  %%%%%%%%%%
  ...
  \def\colophonokuduke{%
    著　者 & Voice UI Experts \\
印刷所 & 日光企画 \\
%
  }
  \def\colophonrights{%
    
    {\textcopyright} 2020 Voice UI Experts\\
...
{\noindent\reviewtitlefont\Large Voiceflow \& VUI ～虎の巻～} \\
\medskip
